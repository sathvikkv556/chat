      ...
      msgImages.map((url, index) => (
        <div key={index} onClick={() => window.open(url)} className='cursor-pointer rounded'>
         ...
         <button onClick={logout}
          className=" absolute bottom-4 w-full flex justify-center text-white bg-violet-600 hover:bg-violet-700 px-6 py-2 text-sm rounded-full transition-colors duration-200">
  Logout
</button>

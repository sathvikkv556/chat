...
const SideBar = () => {
    ...
    >
      <div className="pb-5">
        <div className="flex justify-between items-center">
          <img src={assets.logo3} alt="logo" className="max-w-40 max-h-10" />
        ...
        <div className="bg-[#282142] rounded-full items-center gap-2 py-3 px-4 mt-5 flex">
  ...
  <p className="px-2 absolute top-4 right-4 text-xs h-5 w-5 flex justify-center items-center rounded-full bg-violet-500/50">
